...
#define FREE_MYSTERY_GIFT                   TRUE    // Frees up Mystery Gift data (876 bytes). Enabled: Mystery Gift needs a link cable/wireless adapter and real Nintendo-distributed event data neither of which apply to this romhack, and freeing it alone closes the SaveBlock1FreeSpace overflow (measured at 65-96 bytes over budget) with a large safety margin for future growth.
