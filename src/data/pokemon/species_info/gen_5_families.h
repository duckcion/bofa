...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_VANILLUXE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_ICE_BODY, ABILITY_LEVITATE, ABILITY_WEAK_ARMOR },
    #else
        .abilities = { ABILITY_ICE_BODY, ABILITY_NONE, ABILITY_WEAK_ARMOR },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_KARRABLAST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_ESCAVALIER}),
    },
    ...
    [SPECIES_SHELMET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_ACCELGOR}),
    },
